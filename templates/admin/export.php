...
if( isset( $_POST['mpc_export'] ) && wp_verify_nonce( sanitize_key(wp_unslash($_POST['mpc_export'])), 'mpc_export_nonce' ) ){
    $export_success = true;
}
        ...
        <?php if( $export_success ) : ?>
            <div class="mpcdp_settings_option visible" data-field-id="footer_theme_customizer">
                <div class="mpcdp_settings_option_field_theme_customizer first_customizer_field">
                    ...
                    <div class="mpcdp_settings_option_description">
                        <div class="mpcdp_option_label"><?php echo esc_html__( 'Exported successfully.', 'multiple-products-to-cart-for-woocommerce' ); ?></div>
                    </div>
                </div>
            </div>
        <?php endif; ?>
            ...
            <div class="mpcdp_row">
                ...
                <div class="mpcdp_settings_option_field mpcdp_settings_option_field_text col-md-6">
                    <div class="mpcdp_settings_submit mpc-file">
                        <div class="submit">
                            <button class="mpcdp_submit_button <?php echo esc_attr( $pro_cls ); ?>" title="Export">
